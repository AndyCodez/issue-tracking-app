class User < ApplicationRecord
  ...
  #It assigns the user a remember token and creates and stores a digest of the token in the db
  def remember
  ...
  def send_issue_open_email
    UserMailer.issue_opened(self).deliver_now
  end
